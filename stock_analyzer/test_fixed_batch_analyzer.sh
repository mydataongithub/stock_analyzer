...
# Skript zum Testen des KORRIGIERTEN Batch-Analysierers mit ausgewählten Test-Symbolen
# Test mit: NOVN.SW, NOV.DE, BAYN.DE, RIVN, XPEV, MDT

BATCH_ANALYZER_PATH="/home/ganzfrisch/finance/stock_analyzer/fixed_batch_stock_analyzer.py"
TEST_SYMBOLS_FILE="/home/ganzfrisch/finance/stock_analyzer/test_symbols.txt"
OUTPUT_DIR="/home/ganzfrisch/finance/stock_analyzer/tests/fixed_results"

# Überprüfen, ob Python-Skript existiert
if [ ! -f "$BATCH_ANALYZER_PATH" ]; then
    echo "Fehler: Fixed Batch Stock Analyzer nicht gefunden unter $BATCH_ANALYZER_PATH"
    exit 1
fi
...
echo "===== FIXED Batch Stock Analyzer Test ====="
